...
const PRODUCTS = [
    ...
    { id:3,  cat:'plugin', catLabel:'Plugin',  name:'Vulanic Anti Cheat',     desc:'Vulcan Anti-Cheat | Advanced Cheat Detection | 1.8-26.1.2 | Folia Supported! 2.9.7.23',      price:'Rp 10.000',     rawPrice:10000,  img:'images/product-3.jpg',  badge:'NEW', downloadLink:'https://drive.google.com/file/d/1Yw35MlOppj3-rSTw_R3okL7iqwLD0nLE/view?usp=drivesdk' },
    { id:4,  cat:'plugin', catLabel:'Plugin',  name:'Citizen',                desc:'Basic NPCs - right click messages, items, looking around, waypoints, and much more..',        price:'Rp 15.000',     rawPrice:15000,  img:'images/product-4.jpg',  badge:'',    downloadLink:'https://drive.google.com/file/d/1QpvD8n5eCocqwe08k4urnv_tNXyUbHPe/view?usp=drivesdk' },
    ...
    { id:8,  cat:'backup', catLabel:'Backup',  name:'Ultimate Survival Backup',          desc:'Economy Setver backup , menggunakan plugin premium versi 1.21 :).',                price:'Rp 25.000', rawPrice:25000,  img:'images/product-8.jpg',  badge:'',    downloadLink:'' },
